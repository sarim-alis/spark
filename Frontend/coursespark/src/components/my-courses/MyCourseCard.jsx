        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" side="top">
            <DropdownMenuItem asChild>
              <Link to={`/courseviewonly/${course.id}`} className="flex items-center gap-2 w-full cursor-pointer text-xs md:text-sm">
            ...
            <DropdownMenuItem asChild>
              <Link to={createPageUrl("Storefront")} target="_self" className="flex items-center gap-2 w-full cursor-pointer text-xs md:text-sm">
