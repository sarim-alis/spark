  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Drawer
        title={
          <div className="flex items-center justify-between pr-6">
            <span className="text-lg font-semibold">Add/Edit</span>
          </div>
        }
        placement="right"
        onClose={() => {
      ...
      <Drawer
        title={
          <div className="flex items-center justify-between pr-6">
            <span className="text-lg font-semibold">Edit Stripe Keys</span>
          </div>
        }
        placement="right"
        onClose={() => {
      ...
      >
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="edit_public_key" className="text-sm font-medium">
                Public Key <span className="text-gray-500 text-xs">(Leave empty to keep current)</span>
              </Label>
              <div className="relative mt-1">
                <Input
                  id="edit_public_key"
                  type={showPublicKey ? 'text' : 'password'}
                  placeholder="pk_test_..."
                  value={editFormData.stripe_api_key}
                  onChange={(e) => setEditFormData({ ...editFormData, stripe_api_key: e.target.value })}
                  className="pr-10"
                />
                <Button
                  type="button"
            ...
            <div>
              <Label htmlFor="edit_secret_key" className="text-sm font-medium">
                Secret Key <span className="text-gray-500 text-xs">(Leave empty to keep current)</span>
              </Label>
              <div className="relative mt-1">
                <Input
                  id="edit_secret_key"
                  type={showSecretKey ? 'text' : 'password'}
                  placeholder="sk_test_..."
                  value={editFormData.stripe_secret_key}
                  onChange={(e) => setEditFormData({ ...editFormData, stripe_secret_key: e.target.value })}
                  className="pr-10"
                />
                <Button
                  type="button"
